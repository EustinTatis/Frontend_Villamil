function traerInformacionMensajes(){
    $.ajax({
        url:"http://168.138.124.209:8080/api/Message/all",
        type:"GET",
        datatype:"JSON",
...
function guardarInformacionMensajes(){
    let var2 = {
        ...
        url:"http://168.138.124.209:8080/api/Message/save",
...
function actualizarInformacionMensajes(idElemento){
    ...
    $.ajax({
        url:"http://168.138.124.209:8080/api/Message/update",
        type:"PUT",
        data:dataToSend,
...
function borrarMensajes(idElemento){
    ...
    let dataToSend=JSON.stringify(myData);
    $.ajax({
        url:"http://168.138.124.209:8080/api/Message/"+idElemento,
        type:"DELETE",
        data:dataToSend,
        contentType:"application/JSON",
        datatype:"JSON",
