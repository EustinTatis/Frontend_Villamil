function traerInformacionReservaciones(){
    $.ajax({
        url:"http://168.138.124.209:8080/api/Reservation/all",
        type:"GET",
        datatype:"JSON",
...
function guardarInformacionReservaciones(){
    let var2 = {
        ...
        url:"http://168.138.124.209:8080/api/Reservation/save",
...
function actualizarInformacionReservaciones(idElemento){
    ...
    $.ajax({
        url:"http://168.138.124.209:8080/api/Reservation/update",
        type:"PUT",
        data:dataToSend,
...
function borrarReservaciones(idElemento){
    ...
    let dataToSend=JSON.stringify(myData);
    $.ajax({
        url:"http://168.138.124.209:8080/api/Reservation/"+idElemento,
        type:"DELETE",
        data:dataToSend,
        contentType:"application/JSON",
        datatype:"JSON",
...
function autoInicioDoctor2(){
    ...
    $.ajax({
        url:"http://168.138.124.209:8080/api/Doctor/all",
        type:"GET",
        datatype:"JSON",
        success:function(respuesta){
            console.log(respuesta);
...
function autoInicioCliente2(){
    console.log("Se está ejecutando")
    $.ajax({
        url:"http://168.138.124.209:8080/api/Client/all",
        type:"GET",
        datatype:"JSON",
        success:function(respuesta){
            console.log(respuesta);
